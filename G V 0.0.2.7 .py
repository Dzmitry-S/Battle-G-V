...
def menu_choice(hero, enemy):
    ...
    while True:
        ...
        if choice == 1:
            ...
            print(battle_choice(hero, enemy))
            break
        else:
            print('Ошибка')
    return
...
def battle_choice(hero, enemy):
    ...
    print('Твой противник --' + enemy.name_character)
    while Hero.hp > 0 or Enemy.hp > 0:
        print('Твой противник :' + enemy.name_character + '---' + enemy.hp)
        print('Твой герой :' + hero.name_character + '---' + hero.hp)
        ...
        while True:
            choice = int(input('Сделай выбор :'))
            if choice == 1:
                print(attack_choice_hero(Hero,Enemy))
                Hero.hp = hero.hp - hero.damage
                Enemy.hp = Enemy.hp - enemy.damage
                break
            elif choice == 2:
                print(defence_choice_hero(Hero,Enemy))
                Hero.hp = hero.hp - hero.damage
                Enemy.hp = enemy.hp - enemy.damage
                break
            elif choice == 3:
                print(ram_choice_hero(Hero,Enemy))
                Hero.hp = hero.hp - hero.damage
                Enemy.hp = enemy.hp - enemy.damage
                break
            else:
        ...
        if Enemy.hp <= 0:
            ...
            print('Твой противник :' + enemy.name_character + '---' + enemy.hp)
            print('Твой герой :' + hero.MyName_name + '---' + hero.hp)
            print(menu_choice(Hero))
        elif Hero.hp <= 0:
